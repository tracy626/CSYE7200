...
object Movie extends App {
  ...
  object MoviesProtocol extends DefaultJsonProtocol {
    ...
    implicit val productionForamt: RootJsonFormat[Production] = jsonFormat4(Production.apply)
    implicit val reviewsForamt: RootJsonFormat[Reviews] = jsonFormat7(Reviews.apply)
    implicit val principalForamt: RootJsonFormat[Principal] = jsonFormat2(Principal.apply)
    implicit val moviesForamt: RootJsonFormat[Movie] = jsonFormat11(Movie.apply)
  }
